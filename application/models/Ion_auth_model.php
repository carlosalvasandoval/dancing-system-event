...
class Ion_auth_model extends CI_Model
{
	...
	{
		$this->datatables->setSelect("CONCAT(first_name,' ',last_name) AS fullname, email, password, groups.name AS rol, active, groups.id AS rol_id, users.id");
		$this->datatables->setFrom("users");
		$this->datatables->setJoin("groups", "users.rol_active = groups.id", "LEFT");
		return $this->datatables->getData();
	}
}
